...
import ru.dikoresearch.data.repository.remote.ProductsLocationRepositoryImpl
...
fun Application.module() {
    ...
    val productsLocationUrl = environment.config.property("warehouse.productLocationUrl").getString()
    ...
    val productsLocationRepository = ProductsLocationRepositoryImpl(
        productsLocationServerUrl = productsLocationUrl,
        client = httpClient
    )
